...
export default function Traumatic({ blogs }) {
  const { t } = useTranslation('common')
  const router = useRouter()
  ...
  return (
    <>
      <Head>
        <title>{t('stories.categories.traumatic')}</title>
        <meta
          name="description"
          content={t('stories.categories.traumatic')}
        />
      </Head>
      <SimpleLayout
        title={t('stories.categories.traumatic')}
        intro={t('stories.categories.traumatic')}
      >
